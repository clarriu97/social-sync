...
Ready to contribute? Here's how to set up social_sync for local development. Before you start you will need the following software installed on your machine:
